...
public class Canadian_Foreset_service {
    ...
    public  int loadForest( String name) throws IOException 
    {
        ...
        String pathname="/Users/apple/Desktop/" + name ;
        ...
        try {
            br = new BufferedReader(new FileReader("/Users/apple/Desktop/"+name));
    ...
    public  int saveForestInFile(Forest tempForest)
    {
        ...
        try {
            ...
            String pathname1="/Users/apple/Desktop/" + tempForest.getName() ;
